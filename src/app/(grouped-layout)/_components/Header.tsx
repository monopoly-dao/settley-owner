  ...
  return (
    <div className='bg-navy py-20 min-h-[360px] -mt-[1px] flex px-[5%] relative'>
      ...
      <div className='z-[2] w-full sm:w-3/5 flex gap-4 flex-col text-white'>
        <h1 className='font-bold text-3xl sm:text-5xl uppercase'>
          Unlock liquidity from your property
        </h1>
        <p className='text-xl'>
          Settley helps homeowners and agents turn property equity into
          immediate liquidity through tokenization.
        </p>
      </div>
    </div>
  );
